...
public class ReferenceFinderWindow : EditorWindow
{
    ...
    //查找资源引用信息%#&f
    [MenuItem("Assets/ProjectF/Find References In Project  %#g", false, 25)]
    static void FindRef()
    {
        InitDataIfNeeded();
        OpenWindow();
    ...
    //打开窗口
    [MenuItem("ProjectF/特效工具/Asset Reference Find/Asset Reference Finder", false, 1000)]
    ...
    public void DrawOptionBar()
    {
        ...
        isDepend = GUILayout.Toggle(isDepend, isDepend ? "Model(Depend)" : "Model(Reference)", toolbarButtonGUIStyle,GUILayout.Width(120));
